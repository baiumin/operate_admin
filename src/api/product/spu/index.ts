...
enum API {
  HASSPU_URL = '/admin/product/', //获取已有的SPU的数据
  ...
  SPUHASSALEATTR_URL = '/admin/product/spuSaleAttrList/', //获取某一个SPU下全部的已有的销售属性接口地址
  ...
  ADDSKU_URL = '/admin/product/saveSkuInfo', //追加一个新增的SKU地址
